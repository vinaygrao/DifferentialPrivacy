...
flags.DEFINE_integer(
    "target_epochs", 20, "Number of epochs to train target and shadow models."
)
flags.DEFINE_integer("attack_epochs", 20, "Number of epochs to train attack models.")
flags.DEFINE_integer("num_shadows", 4, "Number of epochs to train attack models.")
