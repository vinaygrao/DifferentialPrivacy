...
tf.flags.DEFINE_string('data_dir','D:/Vinay/Data','Temporary storage')
tf.flags.DEFINE_string('train_dir','D:/Vinay/Data/train_dir','Where model chkpt are saved')
tf.flags.DEFINE_string('teachers_dir','D:/Vinay/Data/train_dir',
